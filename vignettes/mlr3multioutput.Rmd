...
- Implement sub-class "Multilabel".

- Paper zu Multioutput evaluation tutorial lesen
- "score_multimeasure" function die list of  measures returned

- Default multiout.custom to -1 for max measures

- Splitmultiout should not be features during predict.